...
public:
    Sc_pose(){
        ...
        sub_cloud = n.subscribe<sensor_msgs::PointCloud2>("/rslidar_points", 1, &Sc_pose::call_back_cloud, this);
    }
    void call_back_cloud(const sensor_msgs::PointCloud2ConstPtr& msgCloud){
        ...
        if( min_dist < SC_DIST_THRES ){
            ...
            cout << "x:" << matrixIn(nn_idx, 0) << endl;
            cout << "y:" << matrixIn(nn_idx, 1) << endl;
